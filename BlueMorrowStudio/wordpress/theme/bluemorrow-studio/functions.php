...
function bluemorrow_theme_setup() {
	...
	register_block_pattern_category(
		'bluemorrow',
		array( 'label' => __( 'BlueMorrow Studio', 'bluemorrow-studio' ) )
	);
}
add_action( 'after_setup_theme', 'bluemorrow_theme_setup' );

function bluemorrow_enqueue_assets() {
...
add_action( 'wp_enqueue_scripts', 'bluemorrow_enqueue_assets' );
