...
const revealTargets = document.querySelectorAll(
  [
    ...
    ".bluemorrow-studio-hero__copy > *",
    ".bluemorrow-studio-hero__visual",
    ".bluemorrow-page-hero > *",
    ".bluemorrow-app-showcase__heading > *",
    ".bluemorrow-app-card",
    ".bluemorrow-principles__grid article",
    ".bluemorrow-support-card",
